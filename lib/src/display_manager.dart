...
import 'package:nativeapi/src/ffi/extensions/native_display_t.dart';
import 'package:nativeapi/src/ffi/extensions/native_point_t.dart';
import 'display.dart';
...
class DisplayManager with EventListenerMixin<DisplayListener> {
  ...
  List<Display> getAll() {
    return _bindings.native_display_manager_get_all().dartify();
  }
  ...
  Display getPrimary() {
    return _bindings.native_display_manager_get_primary().dartify();
  }
  ...
  Offset getCursorPosition() {
    return _bindings.native_display_manager_get_cursor_position().dartify();
  }
