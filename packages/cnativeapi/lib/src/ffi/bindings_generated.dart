...
class NativeApiBindings {
  ...
  ffi.Pointer<ffi.Char> native_display_get_id(
    native_display_t display,
  ) {
    return _native_display_get_id(
      display,
    );
  }

  late final _native_display_get_idPtr = _lookup<
  ...
  ffi.Pointer<ffi.Char> native_display_get_name(
    native_display_t display,
  ) {
    return _native_display_get_name(
      display,
    );
  }

  late final _native_display_get_namePtr = _lookup<
          ffi.NativeFunction<ffi.Pointer<ffi.Char> Function(native_display_t)>>(
  ...
  native_point_t native_display_get_position(
    native_display_t display,
  ) {
    return _native_display_get_position(
      display,
    );
  }
  ...
  native_size_t native_display_get_size(
    native_display_t display,
  ) {
    return _native_display_get_size(
      display,
    );
  }
  ...
  native_rectangle_t native_display_get_work_area(
    native_display_t display,
  ) {
    return _native_display_get_work_area(
      display,
    );
  }

  late final _native_display_get_work_areaPtr = _lookup<
  ...
  double native_display_get_scale_factor(
    native_display_t display,
  ) {
    return _native_display_get_scale_factor(
      display,
    );
  }
  ...
  bool native_display_is_primary(
    native_display_t display,
  ) {
    return _native_display_is_primary(
      display,
    );
  }
  ...
  native_display_orientation_t native_display_get_orientation(
    ...
    return native_display_orientation_t
        .fromValue(_native_display_get_orientation(
      display,
    ));
  }
  ...
  int native_display_get_refresh_rate(
    native_display_t display,
  ) {
    return _native_display_get_refresh_rate(
      display,
    );
  }
  ...
  int native_display_get_bit_depth(
    native_display_t display,
  ) {
    return _native_display_get_bit_depth(
      display,
    );
  }
  ...
  ffi.Pointer<ffi.Char> native_display_get_manufacturer(
    ...
    return _native_display_get_manufacturer(
      display,
    );
  }

  late final _native_display_get_manufacturerPtr = _lookup<
          ffi.NativeFunction<ffi.Pointer<ffi.Char> Function(native_display_t)>>(
  ...
  ffi.Pointer<ffi.Char> native_display_get_model(
    native_display_t display,
  ) {
    return _native_display_get_model(
      display,
    );
  }

  late final _native_display_get_modelPtr = _lookup<
          ffi.NativeFunction<ffi.Pointer<ffi.Char> Function(native_display_t)>>(
  ...
  ffi.Pointer<ffi.Char> native_display_get_serial_number(
    ...
    return _native_display_get_serial_number(
      display,
    );
  }

  late final _native_display_get_serial_numberPtr = _lookup<
          ffi.NativeFunction<ffi.Pointer<ffi.Char> Function(native_display_t)>>(
  ...
  ffi.Pointer<ffi.Void> native_display_get_native_object(
    ...
    return _native_display_get_native_object(
      display,
    );
  }

  late final _native_display_get_native_objectPtr = _lookup<
  ...
  /// Memory management
  void native_display_free_string(
    ffi.Pointer<ffi.Char> str,
  ) {
    return _native_display_free_string(
      str,
    );
  }
  ...
  void native_display_free(
    native_display_t display,
  ) {
    return _native_display_free(
      display,
    );
  }
  ...
  late final _native_display_freePtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(native_display_t)>>(
          'native_display_free');
  late final _native_display_free =
      _native_display_freePtr.asFunction<void Function(native_display_t)>();
