...
pub const NATIVE_WINDOW_EVENT_TYPE_CREATED: native_window_event_type_t = 7;
...
unsafe extern "C" {
    pub fn native_window_set_title_bar_colors(
        window: native_window_t,
        background: native_color_t,
        foreground: native_color_t,
    ) -> bool;
}
unsafe extern "C" {
    pub fn native_window_reset_title_bar_colors(window: native_window_t) -> bool;
}
unsafe extern "C" {
...
pub const NATIVE_MENU_BACKEND_NATIVE: native_menu_backend_t = 0;
pub const NATIVE_MENU_BACKEND_WIN_UI3: native_menu_backend_t = 1;
pub type native_menu_backend_t = ::std::os::raw::c_uint;
...
unsafe extern "C" {
    pub fn native_menu_set_backend(menu: native_menu_t, backend: native_menu_backend_t) -> bool;
}
unsafe extern "C" {
    pub fn native_menu_get_backend(menu: native_menu_t) -> native_menu_backend_t;
}
unsafe extern "C" {
    pub fn native_menu_is_backend_supported(backend: native_menu_backend_t) -> bool;
}
unsafe extern "C" {
...
pub const NATIVE_DRAG_OPERATION_MOVE: native_drag_operation_t = 2;
pub const NATIVE_DRAG_OPERATION_LINK: native_drag_operation_t = 3;
pub type native_drag_operation_t = ::std::os::raw::c_uint;
#[doc = " Opaque DragSource handle.\n\n A generational index into the library's handle table, NOT a pointer:\n never dereference it, and compare it against NATIVE_INVALID_DRAG_SOURCE rather than NULL.\n Releasing a handle invalidates it; later calls fail safely instead of\n touching freed memory."]
pub type native_drag_source_t = u64;
...
pub struct native_drag_source_event_t {
    pub type_: native_drag_source_event_type_t,
    pub window_id: native_window_id_t,
    pub position: native_point_t,
    pub data: native_drag_source_event_t__bindgen_ty_1,
}
#[repr(C)]
#[derive(Copy, Clone)]
pub union native_drag_source_event_t__bindgen_ty_1 {
    pub ended: native_drag_source_event_t__bindgen_ty_1__bindgen_ty_1,
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct native_drag_source_event_t__bindgen_ty_1__bindgen_ty_1 {
    pub operation: native_drag_operation_t,
}
impl Default for native_drag_source_event_t__bindgen_ty_1__bindgen_ty_1 {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
impl Default for native_drag_source_event_t__bindgen_ty_1 {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
impl Default for native_drag_source_event_t {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
>;
unsafe extern "C" {
    #[doc = " Creates a DragSource instance; release it with native_drag_source_free()."]
    pub fn native_drag_source_create() -> native_drag_source_t;
}
unsafe extern "C" {
    pub fn native_drag_source_is_supported() -> bool;
}
unsafe extern "C" {
    pub fn native_drag_source_set_file_paths(
        drag_source: native_drag_source_t,
        file_paths: native_string_list_t,
    );
}
unsafe extern "C" {
    pub fn native_drag_source_get_file_paths(
        drag_source: native_drag_source_t,
    ) -> native_string_list_t;
}
unsafe extern "C" {
    pub fn native_drag_source_set_text(
        drag_source: native_drag_source_t,
...
unsafe extern "C" {
    #[doc = " Caller owns the returned string; free it with free_c_str()."]
    pub fn native_drag_source_get_text(
        drag_source: native_drag_source_t,
    ) -> *mut ::std::os::raw::c_char;
}
unsafe extern "C" {
    pub fn native_drag_source_set_image(drag_source: native_drag_source_t, image: native_image_t);
}
unsafe extern "C" {
    #[doc = " Caller owns the returned handle; release it with native_image_free()."]
    pub fn native_drag_source_get_image(drag_source: native_drag_source_t) -> native_image_t;
}
unsafe extern "C" {
    pub fn native_drag_source_set_drag_operation(
        drag_source: native_drag_source_t,
        operation: native_drag_operation_t,
    );
}
unsafe extern "C" {
    pub fn native_drag_source_get_drag_operation(
        drag_source: native_drag_source_t,
    ) -> native_drag_operation_t;
}
unsafe extern "C" {
    pub fn native_drag_source_start_dragging(
        drag_source: native_drag_source_t,
        window: native_window_t,
    ) -> bool;
}
unsafe extern "C" {
    pub fn native_drag_source_is_dragging(drag_source: native_drag_source_t) -> bool;
}
unsafe extern "C" {
    #[doc = " Releases the caller's reference. Safe to call with an invalid or\n already-released handle."]
    pub fn native_drag_source_free(drag_source: native_drag_source_t);
}
unsafe extern "C" {
    #[doc = " Registers @p callback for every DragSourceEvent this DragSource emits.\n @return the listener id, or NATIVE_INVALID_LISTENER_ID on failure."]
    pub fn native_drag_source_add_listener(
        drag_source: native_drag_source_t,
...
#[doc = " Opaque DropTarget handle.\n\n A generational index into the library's handle table, NOT a pointer:\n never dereference it, and compare it against NATIVE_INVALID_DROP_TARGET rather than NULL.\n Releasing a handle invalidates it; later calls fail safely instead of\n touching freed memory."]
pub type native_drop_target_t = u64;
pub const NATIVE_DROP_TARGET_EVENT_TYPE_ENTERED: native_drop_target_event_type_t = 0;
pub const NATIVE_DROP_TARGET_EVENT_TYPE_MOVED: native_drop_target_event_type_t = 1;
pub const NATIVE_DROP_TARGET_EVENT_TYPE_EXITED: native_drop_target_event_type_t = 2;
...
pub struct native_drop_target_event_t {
    pub type_: native_drop_target_event_type_t,
    pub window_id: native_window_id_t,
    pub position: native_point_t,
    pub data: native_drop_target_event_t__bindgen_ty_1,
}
#[repr(C)]
#[derive(Copy, Clone)]
pub union native_drop_target_event_t__bindgen_ty_1 {
    pub dropped: native_drop_target_event_t__bindgen_ty_1__bindgen_ty_1,
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct native_drop_target_event_t__bindgen_ty_1__bindgen_ty_1 {
    pub file_paths: native_string_list_t,
    pub text: *mut ::std::os::raw::c_char,
}
impl Default for native_drop_target_event_t__bindgen_ty_1__bindgen_ty_1 {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
impl Default for native_drop_target_event_t__bindgen_ty_1 {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
impl Default for native_drop_target_event_t {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
pub type native_drop_target_event_callback_t = ::std::option::Option<
    unsafe extern "C" fn(
...
unsafe extern "C" {
    pub fn native_drop_target_is_supported() -> bool;
}
unsafe extern "C" {
    pub fn native_drop_target_get_window_id(
        drop_target: native_drop_target_t,
    ) -> native_window_id_t;
}
unsafe extern "C" {
    pub fn native_drop_target_set_drop_operation(
        drop_target: native_drop_target_t,
        operation: native_drag_operation_t,
    );
}
unsafe extern "C" {
    pub fn native_drop_target_get_drop_operation(
        drop_target: native_drop_target_t,
    ) -> native_drag_operation_t;
}
unsafe extern "C" {
    pub fn native_drop_target_is_active(drop_target: native_drop_target_t) -> bool;
}
unsafe extern "C" {
    #[doc = " Releases the caller's reference. Safe to call with an invalid or\n already-released handle."]
    pub fn native_drop_target_free(drop_target: native_drop_target_t);
}
unsafe extern "C" {
    #[doc = " Registers @p callback for every DropTargetEvent this DropTarget emits.\n @return the listener id, or NATIVE_INVALID_LISTENER_ID on failure."]
...
unsafe extern "C" {
    #[doc = " Unregisters a listener. Returns false if unknown."]
    pub fn native_drop_target_remove_listener(
        drop_target: native_drop_target_t,
        listener_id: native_listener_id_t,
    ) -> bool;
}
pub const NATIVE_FILE_DIALOG_MODE_OPEN_FILE: native_file_dialog_mode_t = 0;
pub const NATIVE_FILE_DIALOG_MODE_OPEN_FILES: native_file_dialog_mode_t = 1;
pub const NATIVE_FILE_DIALOG_MODE_SAVE_FILE: native_file_dialog_mode_t = 2;
pub const NATIVE_FILE_DIALOG_MODE_SELECT_FOLDER: native_file_dialog_mode_t = 3;
pub type native_file_dialog_mode_t = ::std::os::raw::c_uint;
pub const NATIVE_FILE_DIALOG_RESULT_NONE: native_file_dialog_result_t = 0;
pub const NATIVE_FILE_DIALOG_RESULT_ACCEPTED: native_file_dialog_result_t = 1;
pub const NATIVE_FILE_DIALOG_RESULT_CANCELLED: native_file_dialog_result_t = 2;
pub const NATIVE_FILE_DIALOG_RESULT_FAILED: native_file_dialog_result_t = 3;
pub type native_file_dialog_result_t = ::std::os::raw::c_uint;
#[doc = " Opaque FileDialog handle.\n\n A generational index into the library's handle table, NOT a pointer:\n never dereference it, and compare it against NATIVE_INVALID_FILE_DIALOG rather than NULL.\n Releasing a handle invalidates it; later calls fail safely instead of\n touching freed memory."]
pub type native_file_dialog_t = u64;
unsafe extern "C" {
    #[doc = " Creates a FileDialog instance; release it with native_file_dialog_free()."]
    pub fn native_file_dialog_create(mode: native_file_dialog_mode_t) -> native_file_dialog_t;
}
unsafe extern "C" {
    pub fn native_file_dialog_is_supported() -> bool;
}
unsafe extern "C" {
    pub fn native_file_dialog_set_parent_window(
        file_dialog: native_file_dialog_t,
        window: native_window_t,
    ) -> bool;
}
unsafe extern "C" {
    pub fn native_file_dialog_set_file_types(
        file_dialog: native_file_dialog_t,
        extensions: native_string_list_t,
    ) -> bool;
}
unsafe extern "C" {
    pub fn native_file_dialog_set_suggested_file_name(
        file_dialog: native_file_dialog_t,
        name: *const ::std::os::raw::c_char,
    ) -> bool;
}
unsafe extern "C" {
    pub fn native_file_dialog_get_modality(
        file_dialog: native_file_dialog_t,
    ) -> native_dialog_modality_t;
}
unsafe extern "C" {
    pub fn native_file_dialog_set_modality(
        file_dialog: native_file_dialog_t,
        modality: native_dialog_modality_t,
    );
}
unsafe extern "C" {
    pub fn native_file_dialog_open(file_dialog: native_file_dialog_t) -> bool;
}
unsafe extern "C" {
    pub fn native_file_dialog_close(file_dialog: native_file_dialog_t) -> bool;
}
unsafe extern "C" {
    pub fn native_file_dialog_get_result(
        file_dialog: native_file_dialog_t,
    ) -> native_file_dialog_result_t;
}
unsafe extern "C" {
    pub fn native_file_dialog_get_paths(file_dialog: native_file_dialog_t) -> native_string_list_t;
}
unsafe extern "C" {
    #[doc = " Caller owns the returned string; free it with free_c_str()."]
    pub fn native_file_dialog_get_last_error(
        file_dialog: native_file_dialog_t,
    ) -> *mut ::std::os::raw::c_char;
}
unsafe extern "C" {
    #[doc = " Releases the caller's reference. Safe to call with an invalid or\n already-released handle."]
    pub fn native_file_dialog_free(file_dialog: native_file_dialog_t);
}
...
pub const NATIVE_MESSAGE_DIALOG_RESULT_NONE: native_message_dialog_result_t = 0;
pub const NATIVE_MESSAGE_DIALOG_RESULT_PRIMARY: native_message_dialog_result_t = 1;
pub const NATIVE_MESSAGE_DIALOG_RESULT_SECONDARY: native_message_dialog_result_t = 2;
pub const NATIVE_MESSAGE_DIALOG_RESULT_CLOSE: native_message_dialog_result_t = 3;
pub type native_message_dialog_result_t = ::std::os::raw::c_uint;
...
unsafe extern "C" {
    pub fn native_message_dialog_is_extended_supported() -> bool;
}
unsafe extern "C" {
    pub fn native_message_dialog_set_buttons(
...
unsafe extern "C" {
    pub fn native_message_dialog_set_default_button(
        message_dialog: native_message_dialog_t,
        button: native_message_dialog_result_t,
    ) -> bool;
}
unsafe extern "C" {
    pub fn native_message_dialog_set_parent_window(
        message_dialog: native_message_dialog_t,
        window: native_window_t,
    ) -> bool;
}
unsafe extern "C" {
    pub fn native_message_dialog_get_result(
        message_dialog: native_message_dialog_t,
    ) -> native_message_dialog_result_t;
}
unsafe extern "C" {
    pub fn native_message_dialog_is_open(message_dialog: native_message_dialog_t) -> bool;
}
unsafe extern "C" {
    pub fn native_message_dialog_set_input_enabled(
        message_dialog: native_message_dialog_t,
        enabled: bool,
    ) -> bool;
}
unsafe extern "C" {
    pub fn native_message_dialog_set_input_text(
        message_dialog: native_message_dialog_t,
        text: *const ::std::os::raw::c_char,
    ) -> bool;
}
unsafe extern "C" {
    #[doc = " Caller owns the returned string; free it with free_c_str()."]
    pub fn native_message_dialog_get_input_text(
        message_dialog: native_message_dialog_t,
    ) -> *mut ::std::os::raw::c_char;
}
unsafe extern "C" {
    pub fn native_message_dialog_set_checkbox(
        message_dialog: native_message_dialog_t,
        label: *const ::std::os::raw::c_char,
        checked: bool,
    ) -> bool;
...
unsafe extern "C" {
    pub fn native_message_dialog_is_checkbox_checked(
        message_dialog: native_message_dialog_t,
    ) -> bool;
}
unsafe extern "C" {
    pub fn native_message_dialog_set_progress(
        message_dialog: native_message_dialog_t,
        value: f64,
    ) -> bool;
}
...
pub struct native_notification_event_t {
    pub type_: native_notification_event_type_t,
    pub data: native_notification_event_t__bindgen_ty_1,
}
#[repr(C)]
#[derive(Copy, Clone)]
pub union native_notification_event_t__bindgen_ty_1 {
    pub activated: native_notification_event_t__bindgen_ty_1__bindgen_ty_1,
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct native_notification_event_t__bindgen_ty_1__bindgen_ty_1 {
    pub argument: *mut ::std::os::raw::c_char,
}
impl Default for native_notification_event_t__bindgen_ty_1__bindgen_ty_1 {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
impl Default for native_notification_event_t__bindgen_ty_1 {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
impl Default for native_notification_event_t {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
pub type native_notification_event_callback_t = ::std::option::Option<
    unsafe extern "C" fn(
...
unsafe extern "C" {
    pub fn native_notification_manager_initialize() -> bool;
}
unsafe extern "C" {
    pub fn native_notification_manager_shutdown();
}
unsafe extern "C" {
    pub fn native_notification_manager_show(
        title: *const ::std::os::raw::c_char,
        message: *const ::std::os::raw::c_char,
...
unsafe extern "C" {
    pub fn native_notification_manager_remove(tag: *const ::std::os::raw::c_char) -> bool;
}
unsafe extern "C" {
    #[doc = " Caller owns the returned string; free it with free_c_str()."]
    pub fn native_notification_manager_get_last_error() -> *mut ::std::os::raw::c_char;
}
unsafe extern "C" {
...
unsafe extern "C" {
    #[doc = " Unregisters a listener. Returns false if unknown."]
    pub fn native_notification_manager_remove_listener(listener_id: native_listener_id_t) -> bool;
}
...
#[doc = " Opaque WindowDragSession handle.\n\n A generational index into the library's handle table, NOT a pointer:\n never dereference it, and compare it against NATIVE_INVALID_WINDOW_DRAG_SESSION rather than NULL.\n Releasing a handle invalidates it; later calls fail safely instead of\n touching freed memory."]
pub type native_window_drag_session_t = u64;
pub const NATIVE_WINDOW_DRAG_EVENT_TYPE_MOVED: native_window_drag_event_type_t = 0;
pub const NATIVE_WINDOW_DRAG_EVENT_TYPE_ENDED: native_window_drag_event_type_t = 1;
...
pub struct native_window_drag_event_t {
    pub type_: native_window_drag_event_type_t,
    pub window_id: native_window_id_t,
    pub cursor_position: native_point_t,
}
impl Default for native_window_drag_event_t {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
>;
unsafe extern "C" {
    #[doc = " Creates a WindowDragSession instance; release it with native_window_drag_session_free()."]
    pub fn native_window_drag_session_create() -> native_window_drag_session_t;
}
unsafe extern "C" {
    pub fn native_window_drag_session_start(
        window_drag_session: native_window_drag_session_t,
        window: native_window_t,
        anchor: native_point_t,
    ) -> bool;
}
unsafe extern "C" {
    pub fn native_window_drag_session_cancel(window_drag_session: native_window_drag_session_t);
}
unsafe extern "C" {
    pub fn native_window_drag_session_is_active(
        window_drag_session: native_window_drag_session_t,
    ) -> bool;
}
unsafe extern "C" {
    pub fn native_window_drag_session_get_window_id(
        window_drag_session: native_window_drag_session_t,
    ) -> native_window_id_t;
}
unsafe extern "C" {
    pub fn native_window_drag_session_get_anchor(
        window_drag_session: native_window_drag_session_t,
    ) -> native_point_t;
}
unsafe extern "C" {
    #[doc = " Releases the caller's reference. Safe to call with an invalid or\n already-released handle."]
    pub fn native_window_drag_session_free(window_drag_session: native_window_drag_session_t);
}
unsafe extern "C" {
    #[doc = " Registers @p callback for every WindowDragEvent this WindowDragSession emits.\n @return the listener id, or NATIVE_INVALID_LISTENER_ID on failure."]
...
unsafe extern "C" {
    #[doc = " Unregisters a listener. Returns false if unknown."]
    pub fn native_window_drag_session_remove_listener(
        window_drag_session: native_window_drag_session_t,
        listener_id: native_listener_id_t,
    ) -> bool;
}
...
unsafe extern "C" {
    #[doc = " Caller owns the returned handle; release it with native_window_free()."]
    pub fn native_window_manager_get_window_at_point(
        point: native_point_t,
        excluded_window_id: native_window_id_t,
    ) -> native_window_t;
}
unsafe extern "C" {
